...
include: "/customisation_example/customisation_group_b.dashboard.lookml"   # include a LookML dashboard


# This is for users 4,5,6
...
explore: orders {
  ...
  sql_always_where: ${user_id} in (4,5,6) ;;
